...
text representation features. We used different character, lexical and syntactical
features and adapt them for the use with the Croatian language. We used punctuation marks and 
wovels frequency as character features. Word length, sentence length and function words frequencies were used as lexical features.
For the syntax--based features we used those relatively similar to POS tag and POS
