...
\multicolumn{2}{c}{Blogs} & \multicolumn{2}{c}{Books}\\ & Features & Acc
[\%]\hspace{5pt} & $F_1$ [\%]\hspace{10pt} & Acc [\%]\hspace{5pt} & $F_1$ [\%]\hspace{10pt} & Acc [\%]\hspace{5pt} & $F_1$ [\%]\\
\midrule
Function Words ($\mathcal{F}$) & 1 & 88.39 & 87.38 & 87.21 & 87.08 & 97.24 &
97.12 \\ Idf Weighted Function Words ($\mathcal{I}$) & 1 & 87.96 & 86.84 & 87.10
...
method ($\mathcal{N}_1$) & 1 & 71.29 & 68.68 & 56.67 & 54.05 & 80.34 & 79.83 \\
POS \emph{n}-grams -- 2nd method ($\mathcal{N}_2$) & 1 & 76.09 & 72.52 & 67.03 &
66.16 & 91.72 & 91.45 \\ Word Morphological Category ($\mathcal{M}$) & 1 & 61.17
& 58.91 & 58.32 & 57.04 & 67.24 & 66.13 \\ $\mathcal{C}$, $\mathcal{M}$ & 2 &
63.17 & 62.06 & 59.65 & 57.98 & 71.72 & 71.84 \\ $\mathcal{P}$, $\mathcal{F}$ &
2 & 92.41 & 91.93 & 88.75 & 88.69 & \textbf{98.62} & 98.57 \\ $\mathcal{F}$,
...
& 90.22 & 98.62 & 98.57 \\ $\mathcal{P}$, $\mathcal{F}$, $\mathcal{L}$,
...
$\mathcal{C}$ & 5 & 93.46 & \textbf{93.15} & 90.85 & 90.73 & 98.62 &
...
$\mathcal{M}$ & 6 & 93.19 & 92.88 & \textbf{91.51} & \textbf{91.38} & 98.62 &
98.57 \\ $\mathcal{S}$, $\mathcal{P}$, $\mathcal{F}$, $\mathcal{V}$,
