...
used. \cite{stamatatos2001computer} used noun, verb and prepositional phrases
frequencies. Using a Part--of--speech (POS) tagger one can obtain POS tags and
...
\cite{koppel2003exploiting} show the use of grammatical errors and informal
styling (e.g., writing sentences in capital letters) as text features used for
...
Also, there are no other reported methods and results for Croatian or
related languages.
