...
% TODO: Sredi! Uredi citate! Malo ljepše napiši!
...
\citep{stamatatos2001computer}. Osim opisa navedenog postupka rad kao često
korištenu značajku pri prepoznavanju autora navodi raznolikost riječnika autora.
...
pojavljuju samo dva puta (\emph{dislegomena}) i sl. Te mjere su usko vezano uz
dužinu teksta. Rad navodi funkcije (Yule--K (1944) i Honore--R (1979)) koje bi
trebale biti konstantne s obzirom na dužinu teksta, no također se navodi rad
(Tweedie and Baayen, 1998) koji tvrdi da većina takvih funkcija nije neovisna o
duljini teksta. Navode da je raznolikost riječnika nestabilna značajka za
tekstove kraće od 1000 riječi.

Razne vrste oznaka stila \engl{style markers} također navode
\citet{diri2003automatic} te \citet{luyckx2005shallow}.
