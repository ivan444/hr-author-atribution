...
koje gledane samostalno nemaju veliko semantičko značenje. Obično ukazuju na gramatičke odnose ili općenita 
svojstva. \citep{zhao2005effective}. Privlačnost funkcijskih riječi za prepoznavanje autora leži u činjenici
da su one pokazatelj stila pisanja. Neke manje poznate funkcijske riječi - poput prijedloga onkraj, namjesto 
ili zavrh - se rijeđe koriste i mogu vrlo dobro sugerirati autora. Međutim, čak i se i frekvencija korištenja
češćih funkcijskih riječi može vrlo dobro iskoristiti za razlikovanje autora.
...
Promijenom jezika dokumenata, potrebno je ažurirati i skup funkcijskih riječi 
