...
% - Izbaciti sve fusnote
% - Srediti literaturu (prilagoditi je ITI pravilima)
% - Doraditi tablicu (skratiti nazive, možda ubaciti u samo jedan stupac)
% - Ubaciti grafove
...
% \vspace{10pt}
% \centering% 
% \input[width=0.8\linewidth,clip=]{sample-fig.jpg}% 
% \figcaption{\small \textbf{\textsf{Helvetica, 10 points, boldface}}}% 
