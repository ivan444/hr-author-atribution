...
defined in \ref{sec:rijeci-grupe} is marked as ``$\mathcal{G}$'',
...
``$\mathcal{L}$''. Column ``$\top$'' denotes number of correctly
recognized authors, ``$\bot$'' -- incorrectly recognized.
...
% ### FeatureExtractor: FunctionWordGroupFreqExtractor + WordGroupExtractor + FunctionWordOccurNumExtractor
% 0.9118248175182482: C = 32.0, gamma = 0.03125
% ### FeatureExtractor: FunctionWordOccurNumExtractor + MorphosyntacticFeatureExtractor
% 0.92: C = 128.0, gamma = 0.03125
...
$\mathcal{P}$, $\mathcal{F}$, $\mathcal{V}$, $\mathcal{L}$ & 961 & 131 & 88.0\% \\
...
\citep{stamatatos2001computer} and ``Greek data set''
