...
consuming process. Thus, not all of the feature combinations were tested. Results of the evalutaion
...
Total accuracy does not explain the behaviour of a classifier for every class by
