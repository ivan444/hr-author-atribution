...
and Sports under the grant No.~036-1300646-1986. The authors would like to thank Bojana Dalbelo Ba\v{s}i\'c and Jan \v{S}najder for their helpful suggestions.

\bibliographystyle{mysplncs}
\bibliography{literatura}

\section*{List of changes during the revision}

\begin{itemize}
\item Abstract -- modified to include information on different data sets.

\item Section 3 Data Set -- added 2nd, 3rd, and 4th paragraph.

\item Section 6 Evaluation -- modified to include information on different data sets, table 1 modified to include new results.

\item Section 7 Conclusion -- modified 1st and 3rd paragraph.
