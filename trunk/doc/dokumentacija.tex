...
jednostavnu klasifikaciju. Kombiniranje značajki je spajanje (nadovezivanje)
vektora značajki.
...
operacija pa do vrlo zahtjevnih algoritama (npr.~značajke dobivene sintaksnom
analizom prirodnog jezika). 
...
-- realni brojevu tj vektori ite dimenzije
